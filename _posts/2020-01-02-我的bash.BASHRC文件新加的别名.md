...
alias gcamu='git commit -a -m "Update."'
...
alias gstad='git stash drop stash@';
alias gdab='git checkout master && git branch | grep -v "master" | xargs git branch -D';
alias gmc='git rebase -i';
alias nrd='npm run dev';
alias gcur='git checkout myCurrentBranch';
```
